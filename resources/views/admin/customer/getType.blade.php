        ...
        <div class="page-content">
            ...
            <div class="page-header" style="display: flex;justify-content: space-between">
                ...
                <div class="btn-group" style="padding-right: 30px">
                    <a class="btn btn-sm btn-primary" href="{{ route('add-type') }}">
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group btn-corner">
                                                ...
                                                <span class="btn btn-info btn-xs popover-success" data-rel="popover"
                                                    ...
                                                    data-content="<p>Created By: .</p> <p> Created At : </p><hr/><p>Updated By: .</p> <p> Updated At : </p>"><i
                                                        class="fa fa-info-circle"></i>
                                                </span>

                                                <!-- SHOW -->
                                                <a href="#showDetails" role="button" class="btn btn-xs btn-black"
                                                    title="Show" data-toggle="modal" data-name="VIP" data-status="Active">
                                                    <i class="fa fa-eye"></i>
                                                </a>

                                                <!-- EDIT -->
                                                <a href="{{ url('edit-type',$type->id) }}" class="btn btn-xs btn-success" title="Edit">
                                                    <i class="fa fa-pencil-square-o"></i>
                                                </a>

                                                <!-- DELETE -->
                                                <a href="{{ url('delete-type', $type->id) }}"
