                ...
                <div class="col-xs-12">
                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                            <form class="form-horizontal mt-2" action="{{ url('edit-customer-submit',$customer->id) }}"
                                method="POST">
                                @csrf
                                @method('patch')
                                            ...
                                            <div class="input-group width-100">
                                                ...
                                                <select class="form-control select2 select2-hidden-accessible"
                                                    ...
                                                    <option value="showroom"
                                                        {{ $customer->register_from == 'showroom' ? 'selected' : '' }}>
                                                        Showroom</option>
                                                    <option value="eccomerce"
                                                        {{ $customer->register_from == 'eccomerce' ? 'selected' : '' }}>
                                                        Eccomerce</option>
                                                    <option value="both"
                                                        {{ $customer->register_from == 'both' ? 'selected' : '' }}>Both
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                                ...
                                                <select name="customer_type_id" id="customer_type_id"
                                                    ...
                                                    @foreach ($types as $type)
                                                        <option value="{{ $type->id }}"
                                                            {{ $customer->customer_type_id == $type->id ? 'selected' : '' }}>
                                                            {{ $type->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="form-group">
                                            <div class="input-group width-100">
                                                ...
                                                <select class="form-control select2 select2-hidden-accessible" name="gender"
                                                    ...
                                                    <option value="others"
                                                        {{ $customer->gender == 'others' ? 'selected' : '' }}>Others
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="input-group width-100">
                                                ...
                                                <select name="district_id" id="district_id" onchange="getAreas(this)"
                                                    ...
                                                    @foreach ($districts as $district)
                                                        <option value="{{ $district->id }}" {{ $customer->district_id == $district->id? 'selected' : '' }}>{{ $district->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="input-group width-100">
                                                ...
                                                <input type="text" class="form-control" name="zip_code"
                                                    id="customerZipCode" value="{{ $customer->zip_code }}" placeholder="ZIP Code">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="input-group width-100">
                                                ...
                                                <input type="text" class="form-control" name="opening_balance"
                                                    id="opening_balance" value="{{ $customer->opening_balance }}"
                                        ...
                                        <div class="form-group">
                                            <div class="input-group width-100">
                                                ...
                                                <input type="text" class="form-control" name="current_balance"
                                                    id="current_balance" value="{{ $customer->current_balance }}"
                                                    placeholder="Customer Current Balance">
                                            </div>
                                    ...
                                    <div class="col-sm-8" style="display: flex; justify-content: end;">
                                        ...
                                        <div class="col-sm-8 col-xs-8">
                                            <label style="margin-top: 7px">
                                                <input name="status" class="ace ace-switch ace-switch-6" type="checkbox" {{ $customer->status == 1? 'checked' : '' }}>
                                                <span class="lbl"></span>
                                            </label>
                                        </div>
                                        <label class="col-sm-4 col-xs-4 control-label" for="form-field-1-1"
                                        ...
                                        <div class="col-sm-8 col-xs-8">
                                            <label style="margin-top: 7px">
                                                <input name="is_default" class="ace ace-switch ace-switch-6"
                                                    type="checkbox" {{ $customer->is_default == 'Yes'? 'checked': '' }}>
                                                <span class="lbl"></span>
                                            </label>
                                        </div>
