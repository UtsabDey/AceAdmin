                ...
                <div class="col-xs-12">
                    ...
                    <div class="widget-body">
                        <div class="widget-main">
                            <form class="form-horizontal mt-2" action="{{ route('add-type-submit') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6 col-md-offset-3">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group width-100">
                                                ...
                                                <textarea name="percentage" id="percentage" class="form-control" placeholder="Percentage"></textarea>
                                            </div>
                                        </div>
